...
class FedDPGANOptimizer():
    ...
    def __init__(self,  globalDiscriminator, globalGenerator, iNoiseDim, iDiscrUpdatesPerStep =5, iGenUpdatesPerStep = 1,
                 ...
                 dWeightDecayDiscr = 1e-6, dNumStabAdam = 1e-8, sLoss = "cross-entropy", sDevice = "cpu", bVerbose = False,
        ...
        Input:
            ...
            - dClipBound            double, the clipping bound for gradients. Default 1 is "optimal"for sLoss="WGAN".
            ...
            - sLoss                 string, loss used, either "cross-entropy" for basic GAN or "WGAN" for the wasserstein gan
        ...
        if sLoss == "WGAN":
            ...
            raise ValueError(f"Loss type: {sLoss} is not available, only WGAN or cross-entropy")
...
class Discriminator(Module):
    ...
    def __init__(self, iInputDim, sLoss = "cross-entropy", dLambda = 10, lSeq = None, lSeqInfoLoss = None):
        """
        ...
        if sLoss == "WGAN":
            ...
            raise ValueError(f"Loss {sLoss} not available, use WGAN or cross-entropy")
...
def calc_gradient_penalty(discriminator, mReal, mFake, dLambda, rng, sDevice = "cpu"):
    """
    Goal: calculate gradient penalty for Wasserstein gan (WGAN)
    Input:
...
class CnnDiscriminator(Discriminator):
    ...
    def __init__(self, iInputDim, iChannels = 64, sLoss = "WGAN", dLambda = 10):
        """
        ...
        Input: 
            ...
            - sLoss         string, name of loss used, either WGAN or cross-entropy
            - dLambda       double, gradient penalty (only applicable for WGAN)
...
class MlpDiscriminator(Discriminator):
    ...
    def __init__(self, iInputDim, sLoss = "cross-entropy", dLambda = 10, tHiddenNodes = (64,8) ): #256, 256(25,25)
        """
...
class Generator(Module):
    ...
    """
    def __init__(self, iDataDim, iRandomInputDim, sLoss = "cross-entropy", lSeq = None):
        """
        ...
        Input:
            ...
            - sLoss                 string, type of gan, either WGAN or cross-entropy
        Set:
...
class CnnGenerator(Generator):
    ...
    Generator of the GAN
    """
    def __init__(self, iDataDim, iRandomInputDim, iChannels = 64,  sLoss = "cross-entropy"):
        """
...
class MlpGenerator(Generator):
    ...
    def __init__(self, iDataDim, iRandomInputDim, tHiddenNodes = (128, 128), sLoss = "cross-entropy"): #256, 256
        """
...
class FedDPCTGAN():
    ...
    def __init__(self, dMu = 1.0, iSeed = 1234, rng = None, dQuadInitProp = 0.25, iClusters=10, dEps=0.005, bDiscretize = False, sLoss = "cross-entropy",
        ...
        Input:
            ...
            - sLoss                 string, loss of GAN, either "WGAN" for the wasserstein loss with gradient penalty,
            ...
            - dClipBound            double, clipping bound to ensure differential privacy. Default of 1 is "optimal"for WGAN
